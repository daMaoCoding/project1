 ...
 * 流水告警处理：回冲
 */
@StreamAlarmAnnotation(ActionStreamAlarm.PREFIX_ACTION_STREAM_ALARM + ActionStreamAlarm.ACTION_STREAM_ALARM_TYPE_Refund)
public class ActionStreamAlarmRefund extends ActionStreamAlarm {

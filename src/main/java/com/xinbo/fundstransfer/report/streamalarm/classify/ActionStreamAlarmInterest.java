...
@StreamAlarmAnnotation(ActionStreamAlarm.PREFIX_ACTION_STREAM_ALARM
		+ ActionStreamAlarm.ACTION_STREAM_ALARM_TYPE_Interest)
public class ActionStreamAlarmInterest extends ActionStreamAlarm {
	protected static final Logger logger = LoggerFactory.getLogger(ActionStreamAlarmInterest.class);
	...
	protected boolean deal(StringRedisTemplate template, AccountBaseInfo base, StreamAlarmHandler handler,
		...
		logger.info(
				"SB{} [ ACTION STREAM ALARM INTEREST ] >>  amount:{} operator: {} remark: {} bankLogId:{}  ActionId:{}",

...
@ReportUp(Report.REPORT_UP + Report.ACC_TYPE_INBANK + SysBalPush.CLASSIFY_INVST_ERROR)
public class InBankInvstErrorReport extends Report {
	...
	protected void deal(StringRedisTemplate template, String rpushData, ReportCheck check) throws Exception {
		...
		log.info(
				"SB{} [ INBANK INVST ERROR REPORT  ] -> sysBal: {} bankBal: {} diff: {} operator: {} errorId: {} remark: {}",

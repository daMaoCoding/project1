...
public class Rate3Controller extends Base3Common {
	...
	public SimpleResponseData rate(@Valid @RequestBody ReqV3Rate requestBody, BindingResult result)
		...
		List<SysUserProfile> settingList = systemSettingService
				.findByPropertyKey(UserProfileKey.REBATE_SYS_RATE_SETTING.getValue()).stream()
		...
		if (Objects.isNull(profile)) {
			...
			profile.setPropertyKey(UserProfileKey.REBATE_SYS_RATE_SETTING.getValue());
			profile.setPropertyName("返利网返利设置");
		}

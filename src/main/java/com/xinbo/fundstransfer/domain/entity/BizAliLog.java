...
@Entity
@Table(name = "biz_alipay_log")
@JsonInclude(Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class BizAliLog {
	...
	/**
	 * @return the AliRequestId
	 */
	@Column(name = "alipay_request_id")
	public int getAliRequestId() {
		return AliRequestId;
	}

	/**
	 * @param AliRequestId
	 *            the AliRequestId to set
	 */
	public void setAliRequestId(int AliRequestId) {
	...
	public BizAliLog(int id, int fromAccount, Date tradingTime, BigDecimal amount, BigDecimal balance, String remark,
			String summary, String depositor, Date createTime, int status, int AliRequestId) {
		this.id = id;
		this.fromAccount = fromAccount;
		this.tradingTime = tradingTime;
		this.amount = amount;

...
public class BizWechatRequest implements java.io.Serializable {
	...
	public BizWechatRequest(int id, int wechatid, int level, int handicap, int status, BigDecimal amount,

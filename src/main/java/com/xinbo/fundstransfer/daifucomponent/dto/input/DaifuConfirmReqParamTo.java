 ...
 *
 */
public class DaifuConfirmReqParamTo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4005348213053076991L;
	...
	/**
	 * @return the requestTimeStr
	 */
	public String getRequestTimeStr() {
		return requestTimeStr;
	}
	/**
	 * @param requestTimeStr the requestTimeStr to set
	 */

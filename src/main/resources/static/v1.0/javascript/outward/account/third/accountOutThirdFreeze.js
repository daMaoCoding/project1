...
var trHtml='<tr class="noLeftRightPadding">\
                ...
                <td>\
                    <button class="btn btn-xs btn-white btn-warning btn-bold orange contentRight" onclick="showStopTempModal({id},refreshContent)" ><i class="ace-icon fa fa-stop bigger-100 red"></i><span>转停用</span></button>\

...
var trHtml='<tr class="noLeftRightPadding">\
                ...
                <td>\
                    <button class="btn btn-xs btn-white btn-warning btn-bold orange contentRight" onclick="showAllocateModal({id},refreshContent)" contentRight="OutwardAccountThirdEnabled:Allocate:*"><i class="ace-icon fa fa-list bigger-100 red"></i><span>分配</span></button>\
                    <button class="btn btn-xs btn-white btn-warning btn-bold orange contentRight" onclick="showTransferBalanceModal({id},refreshContent)" contentRight="OutwardAccountThirdEnabled:Transfer:*"><i class="ace-icon fa fa-exchange bigger-100"></i><span>转账</span></button>\
                    <button class="btn btn-xs btn-white btn-warning btn-bold orange contentRight" onclick="showStopTempModal({id},refreshContent)" contentRight="OutwardAccountThirdEnabled:StopTemp:*"><i class="ace-icon fa fa-stop bigger-100 red"></i><span>停用</span></button>\
                    <button class="btn btn-xs btn-white btn-warning btn-bold orange contentRight" onclick="showFreezeModal({id},refreshContent)" contentRight="OutwardAccountThirdEnabled:Freeze:*"><i class="ace-icon fa fa-remove bigger-100 red"></i><span>冻结</span></button>\
...
function addAccount(){
    showAddOutAccount(accountTypeOutThird,accountStatusEnabled,function(){
        refreshContent();
    },true);
}
